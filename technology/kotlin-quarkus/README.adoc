...
image::./src/main/resources/META-INF/resources/screenshot/quarkus-school-timetabling-screenshot.png[]
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-kotlin-quarkus-school-timetabling-quickstart:1.0-SNAPSHOT
----
