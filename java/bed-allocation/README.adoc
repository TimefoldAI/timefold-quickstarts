...
|Female in male room |Hard |A female patient cannot be assigned to a male-only room.
|Male in female room |Hard |A male patient cannot be assigned to a female-only room.
|Different gender in same gender room in same night |Hard |Patients of different genders cannot share a same-gender room on the same night.
...
|Department specialty |Soft |A patient's preferred department specialty should match their room's specialty.
|Department specialty not first priority |Soft |Penalizes when a patient is placed based on a non-primary specialty match.
|Preferred patient equipment |Soft |A patient's preferred equipment should be available in the assigned room.
|===
