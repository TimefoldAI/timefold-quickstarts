...
|---------------------------------------|------------|------------------------------------------------------------------------------------------------------------------------------------|
| Talk type compatible timeslot         | ValueRange | A talk can only be assigned to a timeslot compatible with its talk type; incompatible timeslots are excluded from the value range. |
| Talk type compatible room             | ValueRange | A talk can only be assigned to a room compatible with its talk type; incompatible rooms are excluded from the value range.         |
