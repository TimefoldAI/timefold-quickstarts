...
public class SpeakerIdMissingIssue extends ConferenceScheduleIssue {

    public static final IssueCode ISSUE_CODE = IssueCode.of("SPEAKER_ID_MISSING");
    public static final IssueMessage ISSUE_MESSAGE = new IssueMessage("Speaker ID must not be null or blank.");
