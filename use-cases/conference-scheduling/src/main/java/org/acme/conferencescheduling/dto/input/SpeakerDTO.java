...
public record SpeakerDTO(
        @Schema(description = "Unique identifier of the speaker.", required = true, minLength = 1) String id,
        @Schema(description = "Display name of the speaker.", required = true, minLength = 1) String name,
        @Schema(description = "IDs of the timeslots during which this speaker is unavailable.") List<String> unavailableTimeslotIds,
        @Schema(description = "Timeslot tag preferences of this speaker.") TagPreferencesDTO timeslotTags,
        @Schema(description = "Room tag preferences of this speaker.") TagPreferencesDTO roomTags) {
