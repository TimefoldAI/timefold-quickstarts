...
public record VehicleRoutePlanConfigOverrides(
        @ConstraintReference(VehicleRoutePlanConstraintProperties.MINIMIZE_TRAVEL_TIME) @Schema(
                description = "Soft weight of the minimizeTravelTime constraint.",
                minimum = "0") Long minimizeTravelTimeWeight)
        implements
