...
...
$ cd timefold-quickstarts/use-cases/vaccination-scheduling
----
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-vaccination-scheduling-quickstart:1.0-SNAPSHOT
----
