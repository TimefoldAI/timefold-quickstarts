...
image::./src/main/resources/META-INF/resources/screenshot/quarkus-food-packaging-screenshot.png[]
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-food-packaging-quickstart:1.0-SNAPSHOT
----
