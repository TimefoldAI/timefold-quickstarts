...
![Tournament Scheduling Screenshot](./tournament-scheduling-screenshot.png)
...
| Even confrontation count         | Soft   | Balance the number of confrontations between each pair of teams. |
...
2. Run a container:
   ...
   ```sh
   docker run -p 8080:8080 --rm $USER/tournament-scheduling:0.0.1
   ```
