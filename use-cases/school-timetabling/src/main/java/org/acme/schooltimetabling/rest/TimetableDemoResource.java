...
public class TimetableDemoResource {
    ...
    public Response generate(@Parameter(description = "Unique identifier of the demo data.",
       ...
       /*  timeslots.add(new Timeslot(nextTimeslotId++, DayOfWeek.MONDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)));
        ...
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout1",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout1",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout1",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout1",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout1",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout2",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout2",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout2",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout2",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout2",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout3",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout3",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout3",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout3",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout3",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout4",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout4",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout4",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout4",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout4",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout5",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout5",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout5",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout5",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout5",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout6",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout6",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout6",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout6",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout6",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout7",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout7",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout7",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout7",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout7",   "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout8",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout8",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout8",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout8",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout8",   "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout9",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout9",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout9",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout9",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout9",   "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout10",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout10",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout10",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout10",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout10",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout11",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout11",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout11",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout11",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout11",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout12",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout12",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout12",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout12",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout12",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout13",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout13",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout13",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout13",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout13",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout14",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout14",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout14",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout14",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout14",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout15",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout15",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout15",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout15",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Gorilla", "Scout15",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout16",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout16",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout16",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout16",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout16",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout17",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout17",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout17",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout17",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout17",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout18",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout18",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout18",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout18",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout18",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout19",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout19",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout19",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout19",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout19",  "Group C"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout20",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout20",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout20",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout20",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Dogs",    "Scout20",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout21",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout21",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout21",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout21",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout21",  "Group A"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout22",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout22",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout22",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout22",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout22",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout23",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout23",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout23",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout23",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout23",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout24",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout24",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout24",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout24",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout24",  "Group D"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout25",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout25",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout25",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout25",  "Group B"));
        lessons.add(new Lesson(nextLessonId++, "Monkeys", "Scout25",  "Group B"));
        if (demoData == DemoData.LARGE) {
            lessons.add(new Lesson(nextLessonId++, "Math", "A. Scout1", "9th grade"));
            lessons.add(new Lesson(nextLessonId++, "Math", "A. Scout1", "9th grade"));
            lessons.add(new Lesson(nextLessonId++, "Math", "A. Scout1", "9th grade"));
            lessons.add(new Lesson(nextLessonId++, "ICT", "A. Scout1", "9th grade"));
            lessons.add(new Lesson(nextLessonId++, "Physics", "M. Scout3", "9th grade"));
            lessons.add(new Lesson(nextLessonId++, "Geography", "C. Scout5", "9th grade"));
            lessons.add(new Lesson(nextLessonId++, "Geology", "C. Scout5", "9th grade"));
