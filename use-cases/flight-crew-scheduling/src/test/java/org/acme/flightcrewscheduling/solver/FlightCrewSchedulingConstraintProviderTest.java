...
class FlightCrewSchedulingConstraintProviderTest {
    ...
    private static final LocalDateTime BASE = LocalDateTime.of(2024, 1, 1, 0, 0);
    private static final LocalDate BASE_DATE = BASE.toLocalDate();
    ...
    void flightConflict() {
        ...
        Flight flight = new Flight("1", null, BASE, null, BASE.plusMinutes(10));
        FlightAssignment assignment = new FlightAssignment("1", flight);
        assignment.setEmployee(employee);

        Flight overlappingFlight =
                new Flight("1", null, BASE.plusMinutes(1), null, BASE.plusMinutes(11));
    ...
    void transferBetweenTwoFlights() {
        ...
        Flight firstFlight =
                new Flight("1", firstAirport, BASE, secondAirport, BASE.plusMinutes(10));
        ...
        Flight firstInvalidFlight =
                new Flight("2", firstAirport, BASE.plusMinutes(11), secondAirport,
                        BASE.plusMinutes(12));
        ...
        Flight secondInvalidFlight =
                new Flight("3", firstAirport, BASE.plusMinutes(13), secondAirport,
                        BASE.plusMinutes(14));
    ...
    void firstAssignmentNotDepartingFromHome() {
        ...
        employee.setUnavailableDays(List.of(BASE_DATE));

        Flight flight =
                new Flight("1", new Airport("2"), BASE, new Airport("3"),
                        BASE.plusMinutes(10));
        FlightAssignment assignment = new FlightAssignment("1", flight);
        assignment.setEmployee(employee);

        Flight secondFlight =
                new Flight("2", new Airport("2"), BASE.plusMinutes(1), new Airport("3"),
                        BASE.plusMinutes(10));
        FlightAssignment secondAssignment = new FlightAssignment("2", secondFlight);
        secondAssignment.setEmployee(employee);

        Flight thirdFlight =
                new Flight("3", new Airport("2"), BASE.plusMinutes(1), new Airport("3"),
                        BASE.plusMinutes(10));
        ...
        secondEmployee.setUnavailableDays(List.of(BASE_DATE));

        Flight fourthFlight =
                new Flight("4", new Airport("3"), BASE, new Airport("4"),
                        BASE.plusMinutes(10));
    ...
    void lastAssignmentNotArrivingAtHome() {
        ...
        Flight secondFlight =
                new Flight("2", new Airport("3"), BASE.plusMinutes(11), new Airport("4"),
                        BASE.plusMinutes(12));
        FlightAssignment secondAssignment = new FlightAssignment("2", secondFlight);
        secondAssignment.setEmployee(employee);
        ...
        Flight thirdFlight =
                new Flight("3", new Airport("2"), BASE, new Airport("3"),
                        BASE.plusMinutes(10));
        ...
        Flight fourthFlight =
                new Flight("4", new Airport("3"), BASE.plusMinutes(11), new Airport("2"),
                        BASE.plusMinutes(12));
