...
class HaversineDistanceCalculatorTest {
    ...
    void calculateDistance() {
        ...
        Assertions.assertThat(distanceCalculator.calculateDistance(Gent, Brno)).isEqualTo(939748L);

        // Close to the North Pole.
        Location Svolvaer = new Location(68.2359953, 14.5644379);
        Location Lulea = new Location(65.5887708, 22.1518707);
        Assertions.assertThat(distanceCalculator.calculateDistance(Svolvaer, Lulea)).isEqualTo(442297L);
    }
}
