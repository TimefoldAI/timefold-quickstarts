...
public record StayInputDTO(
        ...
        @Schema(description = "Medical equipment required by the patient.") @JsonSetter(
                nulls = Nulls.AS_EMPTY) List<String> patientRequiredEquipments,
        @Schema(description = "Medical equipment preferred by the patient.") @JsonSetter(
                nulls = Nulls.AS_EMPTY) List<String> patientPreferredEquipments,
