...
public final class DemoDataBuilder {
    ...
    public BedPlanInput build() {
        ...
        List<StayDTO> stays = List.of(
                ...
                stay("stay-45", "Delia", FEMALE, 72, 2, List.of(TELEVISION, OXYGEN, NITROGEN, TELEMETRY), List.of(),
                ...
                stay("stay-47", "Elena", FEMALE, 80, 1, List.of(NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(12), firstMonday.plusDays(15), ONCOLOGY),
                stay("stay-48", "Ravi", MALE, 88, 2, List.of(TELEMETRY, TELEVISION), List.of(OXYGEN),
                        firstMonday.plusDays(18), firstMonday.plusDays(20), CARDIOLOGY),
                stay("stay-49", "Helga", FEMALE, 92, 2, List.of(TELEVISION, OXYGEN, NITROGEN), List.of(TELEMETRY),
                ...
                stay("stay-51", "Alice", FEMALE, 12, 2, List.of(NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(4), firstMonday.plusDays(7), CARDIOLOGY),
                stay("stay-52", "Vince", MALE, 19, 2, List.of(TELEMETRY, TELEVISION), List.of(OXYGEN),
                        firstMonday.plusDays(10), firstMonday.plusDays(12), NEUROLOGY),
                stay("stay-53", "Carol", FEMALE, 25, 1, List.of(TELEVISION, OXYGEN, NITROGEN), List.of(TELEMETRY),
                ...
                stay("stay-69", "Leo", MALE, 72, 2, List.of(OXYGEN, TELEMETRY), List.of(TELEVISION),
                ...
                stay("stay-78", "Karen", FEMALE, 33, 1, List.of(TELEVISION), List.of(TELEMETRY),
                        firstMonday, firstMonday.plusDays(3), ONCOLOGY),
                stay("stay-79", "Mona", FEMALE, 36, 2, List.of(NITROGEN, TELEVISION), List.of(TELEMETRY),
                        firstMonday.plusDays(6), firstMonday.plusDays(8), CARDIOLOGY),
                stay("stay-80", "Nora", FEMALE, 41, 2, List.of(), List.of(OXYGEN),
                        firstMonday.plusDays(12), firstMonday.plusDays(17), NEUROLOGY),
                stay("stay-81", "Priya", FEMALE, 44, 1, List.of(NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(21), firstMonday.plusDays(25), ONCOLOGY),
                stay("stay-82", "Rosa", FEMALE, 47, 2, List.of(TELEVISION, NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(29), firstMonday.plusDays(30), CARDIOLOGY),
                stay("stay-83", "Tina", FEMALE, 50, 2, List.of(NITROGEN, TELEVISION), List.of(TELEMETRY),
                        firstMonday, firstMonday.plusDays(2), NEUROLOGY),
                stay("stay-84", "Uma", FEMALE, 52, 1, List.of(), List.of(OXYGEN),
                        firstMonday.plusDays(5), firstMonday.plusDays(10), ONCOLOGY),
                stay("stay-85", "Wendy", FEMALE, 54, 2, List.of(NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(14), firstMonday.plusDays(18), CARDIOLOGY),
                ...
                stay("stay-87", "Yara", FEMALE, 58, 1, List.of(), List.of(TELEVISION),
                        firstMonday.plusDays(26), firstMonday.plusDays(29), ONCOLOGY),
                stay("stay-88", "Jorge", MALE, 60, 1, List.of(OXYGEN, TELEMETRY), List.of(TELEVISION),
                        firstMonday, firstMonday.plusDays(5), CARDIOLOGY),
                stay("stay-89", "Bella", FEMALE, 63, 1, List.of(TELEMETRY, NITROGEN, OXYGEN), List.of(TELEVISION),
                ...
                stay("stay-92", "Noah", MALE, 70, 1, List.of(TELEMETRY, NITROGEN), List.of(OXYGEN),
                        firstMonday.plusDays(27), firstMonday.plusDays(29), NEUROLOGY),
                stay("stay-93", "Fiona", FEMALE, 72, 1, List.of(NITROGEN, TELEMETRY, TELEVISION, OXYGEN), List.of(),
                        firstMonday, firstMonday.plusDays(4), ONCOLOGY),
                stay("stay-94", "Pablo", MALE, 75, 2, List.of(), List.of(TELEMETRY),
                        firstMonday.plusDays(8), firstMonday.plusDays(9), CARDIOLOGY),
                stay("stay-95", "Gina", FEMALE, 80, 2, List.of(TELEVISION), List.of(TELEMETRY),
                        firstMonday.plusDays(12), firstMonday.plusDays(15), NEUROLOGY),
                stay("stay-96", "Ravi", MALE, 88, 1, List.of(OXYGEN, NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(18), firstMonday.plusDays(20), ONCOLOGY),
                stay("stay-97", "Iris", FEMALE, 92, 2, List.of(NITROGEN, TELEMETRY, TELEVISION), List.of(OXYGEN),
                        firstMonday.plusDays(23), firstMonday.plusDays(28), CARDIOLOGY),
                stay("stay-98", "Theo", MALE, 5, 2, List.of(), List.of(TELEMETRY),
                        firstMonday, firstMonday.plusDays(1), NEUROLOGY),
                stay("stay-99", "Kira", FEMALE, 12, 1, List.of(TELEVISION), List.of(TELEMETRY),
                        firstMonday.plusDays(4), firstMonday.plusDays(7), ONCOLOGY),
                stay("stay-100", "Vince", MALE, 19, 2, List.of(OXYGEN, NITROGEN), List.of(TELEMETRY),
                        firstMonday.plusDays(10), firstMonday.plusDays(12), CARDIOLOGY),
                stay("stay-101", "Mira", FEMALE, 25, 2, List.of(NITROGEN, TELEMETRY, TELEVISION), List.of(OXYGEN),
                        firstMonday.plusDays(16), firstMonday.plusDays(21), NEUROLOGY),
