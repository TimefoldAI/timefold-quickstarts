...
class BedScheduleEnvironmentTest {
    ...
    void solve(EnvironmentMode environmentMode) {
        ...
        SolverFactory<BedSchedule> solverFactory = SolverFactory.create(updatedConfig);

        Solver<BedSchedule> solver = solverFactory.buildSolver();
        BedSchedule solution = solver.solve(problem);
