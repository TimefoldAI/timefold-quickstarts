...
image::./src/main/resources/META-INF/resources/screenshot/quarkus-order-picking-screenshot.png[]
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-order-picking-quickstart:1.0-SNAPSHOT
----
