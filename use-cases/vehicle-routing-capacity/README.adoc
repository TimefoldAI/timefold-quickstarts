= Vehicle Routing with capacity (Java, Quarkus, Maven)
...
...
$ cd timefold-quickstarts/use-cases/vehicle-routing-capacity
----
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-vehicle-routing-capacity-quickstart:1.0-SNAPSHOT
----
