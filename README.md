...
|-------------------------------------------------------------------------|--------------------------------------------------------------------------|
| 🚚 <a href="#-vehicle-routing">Vehicle Routing</a>                      | Service Model, Map Integration, Planning List Variable, Shadow Variables |
...
| 🏅 <a href="#-tournament-scheduling">Tournament Scheduling</a>          | Service Model, Pinning, Load Balancing                        |
